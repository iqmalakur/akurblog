  ...
  <div class="py-20">
    <div class="mx-auto max-w-md">
      ...
      <form action="{{ route('login') }}" method="POST">
        ...
        <button type="submit"
          class="rounded-lg bg-blue-700 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300">Login</button>
      </form>
